...
const Nav = () => {
    ...
    return (
        <div className="z-50 fixed bottom-5 left-0 w-full flex items-center justify-center gap-1 pointer-events-none">
            {!collapsed && <div className="flex items-center gap-2 sm:gap-3 pointer-events-auto rounded-[30px] bg-gradient-to-b from-neutral-500/50 to-neutral-600/60 w-fit px-3 sm:px-5 py-3">
            ...
            <div className="flex items-center pointer-events-auto rounded-[30px] bg-gradient-to-b from-neutral-500/50 to-neutral-600/60 w-fit px-3 sm:px-5 py-3 cursor-pointer">
                <div className="pointer-events-auto text-2xl sm:text-3xl md:text-4xl rounded-[30px] flex flex-col items-center justify-center hover:scale-125 transition-all duration-200">
